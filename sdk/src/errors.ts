...
export class InvalidDiscountRateError extends ILNError {
  constructor() {
    super(
      'Invalid discount rate provided.',
      'INVALID_DISCOUNT_RATE',
      'Ensure the discount rate is within the allowed bounds.'
    );
  }
}
...
export class TokenMismatchError extends ILNError {
  constructor() {
    super(
      ...
      'TOKEN_MISMATCH',
      'Verify that the correct token addresses are being used.'
    );
  }
}
...
export class PayerReputationTooLowError extends ILNError {
  constructor() {
    super(
      ...
      'The payer must improve their reputation score before proceeding.'
    );
  }
}
